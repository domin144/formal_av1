...
# coq_makefile -o makefile basic_types.v formal_av1.v parser.v pseudocodes.v 
#
...
.merlin:
	...
	@echo "B /home/domin144/dane/math/coq/av1/formal_av1" >> .merlin
	@echo "S /home/domin144/dane/math/coq/av1/formal_av1" >> .merlin
